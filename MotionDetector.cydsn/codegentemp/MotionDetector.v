// ======================================================================
// MotionDetector.v generated from TopDesign.cysch
// 05/27/2023 at 19:56
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("3d1e4997-e61b-45d0-9d7f-d3fbb92a5bcb/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("3d1e4997-e61b-45d0-9d7f-d3fbb92a5bcb/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module WaveDAC8_v2_10_4 (
	...
	cy_clock_v1_0
		#(.id("f22fcb9d-589a-470d-9292-bc0858f86ef2/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("518daab0-1061-44c8-85f8-414e34ba4fce"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("867ca302-58f2-4ea6-aa4f-b7bacd647d53"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4e3f65f1-d705-4971-a0ef-60c333228bb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 User_LED (
        .connect({
            Net_41,
            Net_49
        })
    );
    defparam User_LED.comp_name = "LED_v1_0";
    defparam User_LED.port_names = "A, K";
    defparam User_LED.width = 2;
    ...
    defparam Yellow.comp_name = "LED_v1_0";
    defparam Yellow.port_names = "A, K";
    defparam Yellow.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("74048803-8424-42de-871c-d0b114b261b5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("70bbda7b-18b6-486a-afd2-9c57eb6c2ded"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e4063312-0434-4269-92a4-0aece25719fb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
